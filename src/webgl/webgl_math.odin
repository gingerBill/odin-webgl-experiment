...
foreign math {
	...
	@(link_name="sin")         sin_f32         :: proc "c" (x: f32)    -> f32 ---
	@(link_name="tan")         tan_f32         :: proc "c" (x: f32)    -> f32 ---
	@(link_name="acos")        acos_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="asin")        asin_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="atan")        atan_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="atan2")       atan2_f32       :: proc "c" (y, x: f32) -> f32 ---
	@(link_name="cosh")        cosh_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="sinh")        sinh_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="tanh")        tanh_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="acosh")       acosh_f32       :: proc "c" (x: f32)    -> f32 ---
	@(link_name="asinh")       asinh_f32       :: proc "c" (x: f32)    -> f32 ---
	@(link_name="atanh")       atanh_f32       :: proc "c" (x: f32)    -> f32 ---
	@(link_name="sqrt")        sqrt_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="inversesqrt") inversesqrt_f32 :: proc "c" (x: f32)    -> f32 ---
	@(link_name="pow")         pow_f32         :: proc "c" (x, y: f32) -> f32 ---
	@(link_name="exp")         exp_f32         :: proc "c" (x: f32)    -> f32 ---
	@(link_name="log")         log_f32         :: proc "c" (x: f32)    -> f32 ---
	@(link_name="exp2")        exp2_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="sign")        sign_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="floor")       floor_f32       :: proc "c" (x: f32)    -> f32 ---
	@(link_name="ceil")        ceil_f32        :: proc "c" (x: f32)    -> f32 ---
	@(link_name="mod")         mod_f32         :: proc "c" (x, y: f32) -> f32 ---	
	@(link_name="fract")       fract_f32       :: proc "c" (x: f32)    -> f32 ---
}
